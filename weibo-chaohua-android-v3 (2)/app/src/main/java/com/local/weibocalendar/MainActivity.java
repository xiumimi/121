...
public class MainActivity extends Activity {
    ...
    private static final String LOGIN_URL =
            "https://passport.weibo.com/sso/signin?entry=miniblog&source=miniblog&disp=page";
    private static final String MOBILE_LOGIN_URL = "https://passport.weibo.cn/signin/login";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(v -> webView.loadUrl(LOGIN_URL));
        toolbar.addView(loginButton, new LinearLayout.LayoutParams(dp(74), dp(42)));

        Button homeButton = smallButton("Home");
        homeButton.setOnClickListener(v -> webView.loadUrl(HOME_URL));
        toolbar.addView(homeButton, new LinearLayout.LayoutParams(dp(74), dp(42)));

        Button searchButton = smallButton("Search");
        searchButton.setOnClickListener(v -> openSelectedDate());
        toolbar.addView(searchButton, new LinearLayout.LayoutParams(dp(82), dp(42)));
        ...
        calendarActions.setPadding(dp(10), 0, dp(10), dp(8));
        calendarPanel.addView(calendarActions, new LinearLayout.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT));

        Button mobileLoginButton = smallButton("Alt Login");
        mobileLoginButton.setOnClickListener(v -> webView.loadUrl(MOBILE_LOGIN_URL));
        calendarActions.addView(mobileLoginButton, new LinearLayout.LayoutParams(0, dp(42), 1));

        toggleCalendarButton = smallButton("Hide Calendar");
        toggleCalendarButton.setOnClickListener(v -> setCalendarVisible(!calendarVisible));
        calendarActions.addView(toggleCalendarButton, new LinearLayout.LayoutParams(0, dp(42), 1));
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
                ...
                if (request.isForMainFrame() && isSsoCrossDomain(request.getUrl())) {
                    view.postDelayed(() -> view.loadUrl(pendingUrl), 250);
                }
            }
    ...
    private void setCalendarVisible(boolean visible) {
        ...
        toggleCalendarButton.setText(visible ? "Hide Calendar" : "Show Calendar");
    }
